...
<!-- PARAMETERS -->
<?php
/** @var \App\Support\ViewModels\Playlist\HomePageViewModel $model  */
?>
...
<!-- CONTENT -->
<!-- Oynatma Listesi Header'ı -->
<section class="grid grid-cols-1 gap-4">
    <?= $this->insert("Components/Playlist/Hero", (array) new \App\Support\ViewProps\Components\Playlist\HeroViewProp(
        header: $header,
    )); ?>
</section>
<!-- Videolar -->
...
<?php else: ?>
    <?= $this->insert("Components/Common/EmptyState", (array) new \App\Support\ViewProps\Components\Common\EmptyStateViewProp(
        ...
        description: 'Bu oynatma listesinde henüz hiç içerik yok',
    )) ?>
<?php endif ?>
<!-- Sayfalama -->
<section class="grid grid-cols-1 gap-4">
